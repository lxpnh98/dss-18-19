...
\begin{figure}
\begin{center}
\includegraphics[scale=0.33]{diagrama_classes_global.png}
\end{center}
...
% falar um pouco do padrão MVC (Model-View-Controller)?

% descrever a funcionalidade das janelas, não as classes

\subsection{Camada de negócio}

% descrever as classes e justificar escolhas de design (eg. por identificadores em vez dos próprios objetos para utilizar menos memória central).

\subsection{Camada de dados}

% descrever a base de dados

% descrever a arquitetura de classes
